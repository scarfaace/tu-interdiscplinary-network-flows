...
echo `date`
python3 src/main/python/transcription/main.py --filename "$feature_extraction_output_file_path" resources/CIC-IDS-2017/labels_CAIA_17.csv > "$out_transcription_file_path"
